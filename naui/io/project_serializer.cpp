...
// static json serialize_note(const NauiNote& n) 
// {
//     return 
// 	{
//         {"start", n.start},
...
// static json serialize_pattern(const NauiMidiPattern& p) 
// {
//     json j;
//     j["name"] = p.name;
...
// static json serialize_timeline_block(const NauiTimelineBlock& b) 
// {
//     json j;
//     j["track_type"] = (b.track_type == NauiTrackType_Midi ? "midi" : "sample");
//     j["start_time"] = b.start_time;
//     j["start_offset"] = b.start_offset;
//     j["length"] = b.length;

//     if (b.track_type == NauiTrackType_Midi)
...
// static json serialize_track(const NauiTrack& t) {
//     json j;
//     j["name"]   = t.name;
//     j["volume"] = t.volume;
//     j["pan"]    = t.pan;
...
//     j["muted"]  = t.muted;
//     j["color"]  = t.color;
//     j["track_type"] = (t.track_type == NauiTrackType_Midi ? "midi" : "sample");
...
// static json serialize_project(const NauiProject& p) 
// {
//     json j;
//     j["volume"] = p.volume;
//     j["bpm"]    = p.bpm;
...
//         json js;
//         js["name"] = s.name;
//         js["type"] = (s.type == NauiSampleType_Mono ? "mono" : "stereo");
...
// static NauiNote deserialize_note(const json& jn) 
// {
//     NauiNote n{};
...
// static NauiMidiPattern deserialize_pattern(const json& jp) 
// {
//     NauiMidiPattern p{};
...
// static NauiTimelineBlock deserialize_timeline_block(const json& jb) 
// {
//     NauiTimelineBlock b{};
//     std::string type = jb.value("track_type", "midi");
//     if (type == "midi") 
// 	{
//         b.track_type    = NauiTrackType_Midi;
//         b.pattern_index = jb.value("pattern_index", 0);

//     } else 
// 	{
//         b.track_type    = NauiTrackType_Sample;
...
// static NauiTrack deserialize_track(const json& jt) {
//     NauiTrack t{};
...
//     t.track_type = (jt.value("track_type", "midi") == "midi") ? NauiTrackType_Midi : NauiTrackType_Sample;
...
// static NauiProject deserialize_project(const json& j) 
// {
//     NauiProject p{};
...
//             s.type        = (js.value("type", "mono") == "stereo") ? NauiSampleType_Stereo : NauiSampleType_Mono;
...
// void naui_project_serializer_save_json(const std::filesystem::path& path, const char* file_name) 
// { 
...
// void naui_project_serializer_load_json(const std::filesystem::path& path) {
